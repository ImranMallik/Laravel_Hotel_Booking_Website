...
@section('content')
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body p-4">
                                <form class="row g-3" action="{{ route('role.permission.update', $role->id) }}"
                                    method="post">
                                    @csrf
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="flexCheckDefaultmain">
                                        <label class="form-check-label" for="flexCheckDefaultmain">Permission All</label>
                                    </div>

                                    <hr>
                                    {{-- permission_groups --}}
                                    @foreach ($permission_goup as $group)
                                        <div class="row">
                                            <div class="col-3">
                                                @php
                                                ...
                                                @foreach ($permissions as $permission)
                                                    <div class="form-check">
                                                        <input class="form-check-input permission-checkbox" type="checkbox"
                                                            name="permission[]" id="flexCheckDefault{{ $permission->id }}"
    ...
    <script>
        $(document).ready(function() {
            $('#flexCheckDefaultmain').on('change', function() {
