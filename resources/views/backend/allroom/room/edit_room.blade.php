                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#primaryhome" role="tab"
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="tab-title">Update Room</div>
                                        </div>
                                    </a>
                                </li>
                                <li class="nav-item" role="presentation">
                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <form class="row g-3" action="{{ route('update.room', $editData->id) }}"
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" value="{{ $editData->total_adult }}"
                                                        class="form-control" id="input2" name="total_adult">
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" value="{{ $editData->size }}"
                                                        class="form-control" id="input2" name="size">
                                                </div>
                                                <div class="col-md-3">
                                                    <label for="input2" class="form-label">Discount (%)</label>
                                                    <input type="text" value="{{ $editData->discount }}"
                                                        class="form-control" id="input2" name="room_discount">
                                                </div>
                                                <div class="col-md-3">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea class="form-control" name="shot_desc" id="input11" rows="3">{{ $editData->short_desc }}</textarea>
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="input11" class="form-label">Long Description</label>
                                                    <textarea class="form-control" name="long_desc" id="summernote" rows="3">{!! $editData->long_desc !!}</textarea>
                                                </div>
