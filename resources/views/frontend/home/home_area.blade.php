                         ...
                         <div class="col-lg-7 col-md-8 p-0">
                             <div class="room-card-content">
                                 ...
                                 <p>
                                     ...
                                     et faucibus felis, sed pulvinar purus.
                                 </p>
                                 <ul>
                 ...
                 <div class="room-card-two">
                     <div class="row align-items-center">
                         <div class="col-lg-5 col-md-4 p-0">
                             <div class="room-card-img">
                                 <a href="room-details.html">
                                     <img src="{{ asset('Frontend/assets/img/room/room-style-img2.jpg') }}"
                                         alt="Images" />
                                 </a>
                             </div>
                         </div>
                 ...
                 <div class="room-card-two">
                     <div class="row align-items-center">
                         <div class="col-lg-5 col-md-4 p-0">
                             <div class="room-card-img">
                                 <a href="room-details.html">
                                     <img src="{{ asset('Frontend/assets/img/room/room-style-img3.jpg') }}"
                                         alt="Images" />
                                 </a>
                             </div>
                         </div>
                 ...
                 <div class="room-card-two">
                     <div class="row align-items-center">
                         <div class="col-lg-5 col-md-4 p-0">
                             <div class="room-card-img">
                                 <a href="room-details.html">
                                     <img src="{{ asset('Frontend/assets/img/room/room-style-img4.jpg') }}"
                                         alt="Images" />
                                 </a>
                             </div>
                         </div>
