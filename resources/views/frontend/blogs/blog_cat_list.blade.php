        ...
        <div class="container">
            <div class="inner-title">
                <ul>
                    ...
                    <li>{{ $bcataName->category_name }}</li>
                </ul>
                <h3>{{ $bcataName->category_name }}</h3>
            </div>
        </div>
    </div>
    <!-- Inner Banner End -->
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-7 col-md-8 p-0">
                                        <div class="blog-content">
                                            ...
                                            <h3>
                                                <a
                                                    href="{{ route('blog-details', $item->post_slug) }}">{{ $item->post_titile }}</a>
                                            </h3>
                            ...
                            <div class="side-bar-categories">
                                @foreach ($bcategory as $cat)
                                    <ul>
                                        ...
                                        <li>
                                            <a
                                                href="{{ route('blog-cat.details', $cat->id) }}">{{ $cat->category_name }}</a>
                                        </li>
                                    </ul>
                                @endforeach
                            </div>
